...
export let extensionSettings = {
    ...
    trackerConfig: {
        userStats: {
            ...
            customStats: [
                { id: 'health', name: 'Health', enabled: true, persistInHistory: false, maxValue: 100, description: '' },
                { id: 'satiety', name: 'Satiety', enabled: true, persistInHistory: false, maxValue: 100, description: '' },
                { id: 'energy', name: 'Energy', enabled: true, persistInHistory: false, maxValue: 100, description: '' },
                { id: 'hygiene', name: 'Hygiene', enabled: true, persistInHistory: false, maxValue: 100, description: '' },
                { id: 'arousal', name: 'Arousal', enabled: true, persistInHistory: false, maxValue: 100, description: '' }
            ],
        ...
        presentCharacters: {
            ...
            characterStats: {
                enabled: false,
                customStats: [
                    { id: 'health', name: 'Health', enabled: true, description: '' },
                    { id: 'arousal', name: 'Arousal', enabled: true, description: '' }
                ]
            }
        }
    },
